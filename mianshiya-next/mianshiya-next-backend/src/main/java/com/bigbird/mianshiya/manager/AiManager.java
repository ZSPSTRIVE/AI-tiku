package com.bigbird.mianshiya.manager;
...
import com.bigbird.mianshiya.config.AiConfig;
...
public class AiManager {
    ...
    public String doChat(String userPrompt) {
        return doChat("", userPrompt, aiConfig.getDefaultModel());
    }
    ...
    public String doChat(String systemPrompt, String userPrompt) {
        return doChat(systemPrompt, userPrompt, aiConfig.getDefaultModel());
    }
    ...
    public String doChat(List<ChatMessage> messages) {
        return doChat(messages, aiConfig.getDefaultModel());
    }
